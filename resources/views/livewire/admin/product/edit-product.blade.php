    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="md:col-span-2 space-y-6">
            <flux:card>
                <div class="space-y-6">
                    ...
                    <div>
                        <flux:input wire:model="slug" label="Slug" placeholder="vintage-leather-jacket" />
                    </div>
            ...
            <flux:card>
                <div class="mb-4">
                    <h3 class="text-lg font-medium text-zinc-900 dark:text-white">Product Images</h3>
                    <p class="text-sm text-zinc-500">Manage existing images and upload new ones.</p>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="relative group rounded-lg border border-zinc-200 dark:border-zinc-700 p-2 flex flex-col items-center">
                            <img src="{{ $image['image_url'] }}" class="w-full h-32 object-cover rounded-md mb-2">

                            <div class="absolute top-2 right-2 flex gap-2">
                                <button type="button" wire:click="removeExistingImage({{ $image['id'] }})" class="p-1 bg-red-500 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div class="pt-4 border-t border-zinc-100 dark:border-zinc-800">
                        <flux:input type="file" wire:model="images" multiple accept="image/*" label="Upload New Images" />

                        @if ($images)
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                            @foreach ($images as $index => $image)
                            <div class="relative group rounded-lg border border-zinc-200 dark:border-zinc-700 p-2 flex flex-col items-center opacity-70">
                                ...
                                <span class="text-xs mt-1 text-zinc-500 italic">New Upload</span>
                            </div>
                            @endforeach
                        </div>
                        @endif
            ...
            <flux:card>
                <div class="mb-4 flex justify-between items-center">
                    <div>
                        <h3 class="text-lg font-medium text-zinc-900 dark:text-white">Product Variants</h3>
                        <p class="text-sm text-zinc-500">Add different sizes, colors, and prices.</p>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg relative">
                        @if(count($variants) > 1)
                        <button type="button" wire:click="removeVariant({{ $index }})" class="absolute top-4 right-4 text-zinc-400 hover:text-red-500">
        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col gap-4">
                <flux:button type="submit" variant="primary" class="w-full">Update Product</flux:button>
